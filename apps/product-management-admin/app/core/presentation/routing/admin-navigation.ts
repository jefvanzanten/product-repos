...
import { parseAdminSource, type AdminSource } from "../../domain/admin-source";

export { parseAdminSource } from "../../domain/admin-source";
export type { AdminSource } from "../../domain/admin-source";
