...
/**
 * Collect all descendants for move destination filtering.
 *
 * @param node - Moving location subtree root.
 * @returns Descendant identifiers excluding the root itself.
 */
export function collectLocationDescendantIds(node: LocationTreeNode): ReadonlySet<number> {
