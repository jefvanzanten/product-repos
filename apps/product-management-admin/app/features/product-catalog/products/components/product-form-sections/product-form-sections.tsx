...
import type { ConsumptionType, MacroProfile } from "@product-repos/contracts";
...
export function ConsumptionTypeSection({ error, value }: { readonly error?: string; readonly value?: ConsumptionType | string }): React.ReactNode {
