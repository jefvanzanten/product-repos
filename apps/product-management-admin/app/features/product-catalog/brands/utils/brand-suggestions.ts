import type { BrandDto } from "@product-repos/contracts";
 ...
 */
export function findBrandNameById(brands: ReadonlyArray<BrandDto>, brandId: string | undefined): string | undefined {
 ...
 */
export function filterBrandSuggestions(brands: ReadonlyArray<BrandDto>, query: string): ReadonlyArray<BrandDto> {
 ...
 */
export function dedupeBrands(brands: ReadonlyArray<BrandDto>): ReadonlyArray<BrandDto> {
