...
import { CatalogActionGroup, CatalogPrimaryLink } from "../../../catalog/components/catalog-actions/catalog-actions";
  ...
  return (
    <>
      ...
      <CatalogActionGroup variant="card">
        <CatalogPrimaryLink to={`/product-catalogus/nieuw?brandId=${browse.brand.id}`}>Product aanmaken voor {browse.brand.name}</CatalogPrimaryLink>
      </CatalogActionGroup>
    </>
  );
}
