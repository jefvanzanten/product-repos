...
import { useAdminPath, useAdminSource } from "../../../../../core/presentation/routing/admin-source-context";
import { buildCategoryTreeOptions, type CategoryTreeOption } from "../../../domain/category-tree";
...
type UseNewProductCategoryResult = {
  readonly breadcrumbPath: ReadonlyArray<Category>;
 ...
 */
export function useNewProductCategory({ categories, defaultCategoryId }: { readonly categories: ReadonlyArray<Category>; readonly defaultCategoryId: string }): UseNewProductCategoryResult {
