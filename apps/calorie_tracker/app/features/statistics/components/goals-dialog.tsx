...
import { createGoalDraft, parseGoalDraft, type GoalDraft } from "../utils/goals-draft";
 ...
 */
  ...
  return (
    <FocusDialog title="Persoonlijke dagdoelen" onClose={onClose}>
